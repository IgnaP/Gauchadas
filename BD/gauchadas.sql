...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-05-2017 a las 17:04:49
...
CREATE TABLE `compra_creditos` (
  `ID_compra` mediumint(11) NOT NULL,
  `ID_usuario` int(11) NOT NULL,
...
INSERT INTO `reputacion` (`ID`, `Nombre`, `Puntos`, `vigente`) VALUES
(1, 'Negativa', -1, 0),
(2, 'Observador', 0, 0),
(3, 'Buen tipo', 1, 0),
(4, 'Gran tipo', 2, 0),
...
CREATE TABLE `usuarios` (
  ...
  `Puntaje` mediumint(9) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci ROW_FORMAT=COMPACT;
...
ALTER TABLE `usuarios`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `Reputacion` (`Reputacion`),
  ADD KEY `PreguntaDeSeguridad` (`PreguntaDeSeguridad`);
...
--
ALTER TABLE `compra_creditos`
  MODIFY `ID_compra` mediumint(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `calificaciones`
  ADD CONSTRAINT `calificaciones_ibfk_1` FOREIGN KEY (`ID_usuario`) REFERENCES `usuarios` (`ID`) ON UPDATE CASCADE,
  ADD CONSTRAINT `calificaciones_ibfk_2` FOREIGN KEY (`ID_publicacion`) REFERENCES `publicaciones` (`ID`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `comentarios`
--
ALTER TABLE `comentarios`
  ADD CONSTRAINT `comentarios_ibfk_1` FOREIGN KEY (`UsuarioID`) REFERENCES `usuarios` (`ID`) ON UPDATE CASCADE,
  ADD CONSTRAINT `comentarios_ibfk_2` FOREIGN KEY (`Publicacion`) REFERENCES `publicaciones` (`ID`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `compra_creditos`
--
ALTER TABLE `compra_creditos`
  ADD CONSTRAINT `compra_creditos_ibfk_1` FOREIGN KEY (`ID_credito`) REFERENCES `credito` (`ID_credito`) ON UPDATE CASCADE,
  ADD CONSTRAINT `compra_creditos_ibfk_2` FOREIGN KEY (`ID_usuario`) REFERENCES `usuarios` (`ID`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `localidades`
--
ALTER TABLE `localidades`
  ADD CONSTRAINT `localidades_ibfk_1` FOREIGN KEY (`id_provincia`) REFERENCES `provincias` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `postulantes`
--
ALTER TABLE `postulantes`
  ADD CONSTRAINT `postulantes_ibfk_1` FOREIGN KEY (`publicacionID`) REFERENCES `publicaciones` (`ID`) ON UPDATE CASCADE,
  ADD CONSTRAINT `postulantes_ibfk_2` FOREIGN KEY (`usuarioID`) REFERENCES `usuarios` (`ID`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `publicaciones`
--
ALTER TABLE `publicaciones`
  ADD CONSTRAINT `publicaciones_ibfk_1` FOREIGN KEY (`Ciudad`) REFERENCES `localidades` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `publicaciones_ibfk_2` FOREIGN KEY (`Categoria`) REFERENCES `categorias` (`ID`) ON UPDATE CASCADE,
  ADD CONSTRAINT `publicaciones_ibfk_3` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`ID`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `usuarios`
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `usuarios_ibfk_1` FOREIGN KEY (`Reputacion`) REFERENCES `reputacion` (`ID`) ON UPDATE CASCADE,
  ADD CONSTRAINT `usuarios_ibfk_2` FOREIGN KEY (`PreguntaDeSeguridad`) REFERENCES `preguntas` (`ID`) ON UPDATE CASCADE;
