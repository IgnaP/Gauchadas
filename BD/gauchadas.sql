...
ALTER TABLE `comentarios`
  ...
  ADD CONSTRAINT `comentarios_ibfk_2` FOREIGN KEY (`Publicacion`) REFERENCES `publicaciones` (`ID`) ON DELETE CASCADE;
...
ALTER TABLE `postulantes`
  ...
  ADD CONSTRAINT `postulantes_ibfk_3` FOREIGN KEY (`publicacionID`) REFERENCES `publicaciones` (`ID`) ON DELETE CASCADE;
...
ALTER TABLE `publicaciones`
  ...
  ADD CONSTRAINT `publicaciones_ibfk_4` FOREIGN KEY (`Ciudad`) REFERENCES `localidades` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
